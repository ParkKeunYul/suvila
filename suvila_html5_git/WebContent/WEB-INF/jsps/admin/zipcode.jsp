...
<title></title>
	...
	<link type="text/css" rel='stylesheet' href="/assets/admin/css/style.css" />
	<link type="text/css" rel="stylesheet" href="http://code.jquery.com/ui/1.10.2/themes/ui-lightness/jquery-ui.css" />
	<link type="text/css" rel='stylesheet' href="/assets/admin/js/jquery/_fancybox2.0/jquery.fancybox.css?v=2.1.4"  media="screen"/>
	<link rel="stylesheet" type="text/css" href="/assets/admin/js/jquery/_fancybox2.0/helpers/jquery.fancybox-buttons.css?v=1.0.5" />
	<link rel="stylesheet" type="text/css" href="/assets/admin/js/jquery/_fancybox2.0/helpers/jquery.fancybox-thumbs.css?v=1.0.7" />
...
<!--
	...
	input[type=text]	{ padding:6px 10px 3px; border:3px solid #F7AE36; }
...
<body>
	<h1><span style="color:#999999;">우편번호 검색 및 주소찾기</span></h1>
	 	...
	 	<div id="a">
	 		<form action="/zipcode/bunziCode" method="get" name="frm" id="frm">
	 			<fieldset>
					...
					<input type="button" value="찾기" class="btn" style="height:30px;" onclick="addr();"/><br>
				</fieldset>
				<div id="dongBoxList">
	 	...
	 	<div id="b">
	 		<form action="/zipcode/doroCode" method="get" name="frm2" id="frm2" >
				<fieldset>
					...
					<input type="button" value="찾기" class="btn" style="height:30px;" onclick="doroAddr();">

...
for( int a = 0 ; a<l_Folders.size() ; a++ ){
	...
	for (int a1 = 0; a1 < l_Files1.size(); a1++) {
		...
		String fileName = l_Files1.elementAt(a1).toString().replace(".js", ""); 
		System.out.println("a1" + a1 + "," + fileName);
		sb.append("            name:'" + fileName + ".js',\n");
		sb.append("            url:'ExFrm.view." + folderName + "." + fileName + "',\n");

Ext.define('ExFrm.view.asp.asp044w_02Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.asp044w_02',    
    ...
    dsTempleCallbak : function(me, success, form, action){
    	if(success){
    		me.lookupReference('asp044w_02_a').getView().select(0);
    	}
	},
	onSelectionTemple : function( me2 , record , selections , eOpts ) {
    	...
    	try{
    		...
    		var selection = me.lookupReference('asp044w_02_a').getView().getSelectionModel().getSelection()[0];
	...
	onSelectCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('asp044w_02_b').getView().select(0);
    	}
    },
   ...
   inSindoInfo : function(sindo_light_no){
    ...
    onSave : function(){
    	...
    	var cnt = exCommon.ChangeCount('ds_YDRec', me);
    	...
    	exCommon.uptParamSetting(me, 'ds_YDRec', 'uptData');
    	...
    	exCommon.fnGridSaveAll( me
    			               ...
    			               ,'uptData'
    			               ,'delData'
    			               ,'/asp/ASP044W_01/ydeungSave.suvila'
    			               , me.onSaveCallback);

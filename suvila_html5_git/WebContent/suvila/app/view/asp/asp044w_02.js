Ext.define('ExFrm.view.asp.asp044w_02',{
	extend:'ExFrm.view.widget.container.ExWindowMain',
	alias:'widget.asp044w_02',
	requires:[
		'ExFrm.view.asp.asp044w_02Controller',
        'ExFrm.view.asp.asp044w_02Model'
	],
	controller:'asp044w_02',
	viewModel:{
        type:'asp044w_02'
    },
    name:'asp044w_02',
	        ...
	        items:[{
	        	...
	        	items  : [{
	        		...
	        		items  : [{
	        			...
	        			exGroupRef    : true,
	                    xtype         : 'exgrid',
	                    reference     : 'asp044w_02_a',
	                    cls           : 'none-dirty-grid asp044w_02_a',
	                    height        : 800,
	                    width         : '100%',
	                    bind          : {
	                        store:'{ds_templeCd}'
	        		...
	        		items  : [{
	        			...
	        			items  : [{
		        			...
		        			xtype        :'excombobox',
		        			fieldLabel   : '<span style="font-weight: 700;text-align:right;display:inline-block;">연등명 </span>',
		        			labelWidth   :50,
	        			...
	        			exGroupRef    : true,
	                    xtype         : 'exgrid',
	                    reference     : 'asp044w_02_b',
	                    cls           : 'none-dirty-grid asp044w_02_b',
	                    height        : 427,
	                    width         : '100%',	                    
	                    bind          : {
	                        store:'{ds_YDRec}'

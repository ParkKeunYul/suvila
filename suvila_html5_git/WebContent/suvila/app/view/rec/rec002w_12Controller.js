Ext.define('ExFrm.view.rec.rec002w_12Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_12',    
    ...
    dsaJkindnCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_BSKindInfo', '', null ,me.dsBsKindCallback);
    	},50);   	    	
    },
    dsBsKindCallback : function(me, success, form, action){
    ...
    dsDetailCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec002w_12_a').getView().select(0);
    	}
    },
    onExcel : function (){
var me = this;
    	...
    	jsonAllData = {
      	...
      	var params = {
  			 FILE_PATH  : '/rec002w_12_excel.ozr' 

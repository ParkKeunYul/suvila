Ext.define('ExFrm.view.rec.rec003w_43Model', {
    extend:'Ext.app.ViewModel', 
    alias: 'viewmodel.rec003w_43', 
    stores:{ 
    	ds_giJae :{
         	fields:['field1'],
         	proxy:{
                 type:'ajax',
                 url:'/rec/REC003W_43/selectChon.suvila',
                 reader:{
                     type:'json',
        ...
        ds_giJaeSpirit :{
         	...
         	proxy:{
                 type:'ajax',
                 url:'/rec/REC003W_43/chonDoSB.suvila',
                 reader:{
                     type:'json',
                     rootProperty:'data.list'                    
                 }
        ...
        ds_giJaeBokwi :{
         	...
         	proxy:{
                 type:'ajax',
                 url:'/rec/REC003W_43/chonDoSBBok.suvila',
                 reader:{
                     type:'json',
                     rootProperty:'data.list'                    
                 }

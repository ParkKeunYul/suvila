Ext.define('ExFrm.view.rec.rec024w_05Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec024w_05',
    ...
    onTooltipRender: function (tooltip, record, item) {
        tooltip.setHtml("상시접수 "+ exCommon.getGridDateFormat(record.get('SUB_DATE'), "/",8) + ': ' +record.get('AMOUNT1')+"원");

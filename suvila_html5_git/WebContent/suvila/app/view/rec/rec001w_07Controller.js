Ext.define('ExFrm.view.rec.rec001w_07Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec001w_07',
    onDestroy : function() {
    },
    ...
    onDeungChange : function(field, newValue, oldValue, options) {
    	var me = this;
    	
    	me.lookupReference('jungakGbn').setValue({jungakGbn : 'I'});
    	
    	console.log(newValue.rdo_ApprovalGbn);
    	
    	me.inDeungReload( me 
						 ,newValue.rdo_ApprovalGbn
						 ,me.lookupReference('jungakGbn').getValue().jungakGbn
						 ,'start');

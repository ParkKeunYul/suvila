Ext.define('ExFrm.view.rec.rec011w_04',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec011w_04',
    requires:[
    	'ExFrm.view.rec.rec011w_04Controller',
        'ExFrm.view.rec.rec011w_04Model'
    ],
    controller:'rec011w_04',
    viewModel:{
        type:'rec011w_04'
    },
    name:'rec011w_04',
        ...
        items :[{
        	...
        	items  : [{
        		...
        		items  : [{
        			...
        			xtype        :'excombobox',
                	labelWidth   : 60,
                    fieldLabel   : '<span style="font-weight: 700;">후원명</span>',
                    width        : 250,
                    valueField   : 'SUPPORT_CODE',
                    displayField : 'SUPPORT_NM',     
        		...
        		width  : '100%',
        		items  : [{
    				html : '<div style="height : 31px;width: 90px;background-color:#3892d4;color:#ffffff;font-weight:700;line-height:30px;text-align:center;border-top-left-radius:5px;center;border-top-right-radius:5px;">수납현황</div>',	        				
    				flex : 1,	        				
    			},{
    				html : '<img src="./resources/img/rec/rec000p_02.png" height="31px" width="432px" style="vertical-align:middle;" >',
    			}]
        	},{
				/*무한 유한 납부 그리드*/
				exGroupRef : true,

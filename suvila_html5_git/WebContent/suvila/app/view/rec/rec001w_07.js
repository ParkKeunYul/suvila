Ext.define('ExFrm.view.rec.rec001w_07',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec001w_07',
    requires:[
    	'ExFrm.view.rec.rec001w_07Controller'
    	,'ExFrm.view.rec.rec001w_07Model'    	
    ],
    controller:'rec001w_07',
    viewModel:{
        type:'rec001w_07'
    },
    name:'rec001w_07',
    ...
    items:[{ 
        ...
        items :[{
        	...
        	items  : [{
    	    	...
    	    	html : '<div id="rec001w_07" class="find_addr_layer_pop" style="display:none;position:fixed;overflow:hidden;z-index:3;-webkit-overflow-scrolling:touch;top:400px;left:600px;" width="409" height="129"><img src="./resources/img/rec/loading.png" width="409" height="129"></div>'
        			...
        			items        : [{
        				...
        				items  : [{
    						...
    						items     : [{
                		    	...
                		    	xtype     : 'exbutton',
                        		reference : 'onJungakCancelBtn',
                        		name      : 'onJungakCancelBtn',

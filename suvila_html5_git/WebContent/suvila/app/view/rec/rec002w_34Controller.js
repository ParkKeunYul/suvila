Ext.define('ExFrm.view.rec.rec002w_34Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_34',
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
   			me.lookupReference('rec002w_34_b').getView().select(action._params.G_ROW_INDEX);
    	}
    },
    onSelectionChangeBS : function( me2 , record , selections , eOpts ) {
    	var me = this;
    	try{
    		if(record.length <=  0) return false;
    		
    		var selection = me.lookupReference('rec002w_34_b').getView().getSelectionModel().getSelection()[0];
    		...
    		setTimeout(function(){
        		me.callStore(me, 'ds_MisuAmtBS', '', params ,me.dsMisuCallback);
        	},50);
    ...
    dsMisuCallback : function(me, success, form, action){
    	me.lookupReference('rec002w_34_d').getView().select(0);
    },
    onExcel : function(){
    	var me = this;
    	
   		var grid = me.lookupReference('rec002w_34_b');

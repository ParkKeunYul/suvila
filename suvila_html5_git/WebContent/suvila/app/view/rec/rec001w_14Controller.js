Ext.define('ExFrm.view.rec.rec001w_14Controller', {
   ...
   /* selectLimitCallback : function(me, success, form, action){
    ...
    onExcelSunap : function(){
        ...
        exCommon.excelDown(grid, 'YEONDEUNG', '연등납부내역',  me.getViewModel().getStore('ds_misuRecYD').getCount());
    },
    onExcel : function(){
    	var me = this;
    	
    	var grid = me.lookupReference('rec001w_14_b');
        exCommon.excelDown(grid, 'YEONDEUNG', '연등접수조회',  me.getViewModel().getStore('ds_YDRec').getCount());
    },

Ext.define('ExFrm.view.rec.rec011w_04Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec011w_04',
    ...
    dsclassMgtCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_supportMgt', '', null ,me.dsSupportMgtCallback);
    	},50);
    },
    dsSupportMgtCallback : function(me, success, form, action){
    	setTimeout(function(){
    ...
    onSelect : function(){
    	...
    	var params = {
    		...
    		,V_PROPOSAL_BUD_NO  : me.lookupReference('hid_bud_no').getExValue()
       		...
       		,V_SUPPORT_CODE     : me.lookupReference('lc_KindInfo').getExValue()
       		,V_FDATE            : V_FDATE
    ...
    onSelectCallback : function(me, success, form, action){
    	...
    	if(success){
    		me.lookupReference('rec011w_04_a').getView().select(0);    		
    	}
    },
    ...
    dspayCallback : function(me, success, form, action){
    	setTimeout(function(){
			me.callStore(me, 'ds_MisuAmt', '', action._params ,null);    				
		},50);
    },
    onSave : function(){
    	var me = this;
    	...
    	exCommon.fnGridSaveAll(
   			...
   			,'uptData'
   			,'delData'
   			,'/rec/REC011W_03/saveDetail.suvila'
   			,me.onSaveCallback
	   	);
    },
    ...
    onExcel : function(){
    	...
    	var grid = me.lookupReference('rec011w_04_a');
    	exCommon.excelDown(grid, 'temple', '후원접수 접수내역',  me.getViewModel().getStore('ds_detail').getCount());    	
    },
    onDateField : function(){

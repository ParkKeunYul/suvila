Ext.define('ExFrm.view.rec.rec014w_07Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec014w_07',
    onDestroy : function() {
    },
    ...
    inSindoInfoCallback : function(me, success, form, action){
    	me.lookupReference('rec000p_03_c').getView().select(0);

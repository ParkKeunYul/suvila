Ext.define('ExFrm.view.rec.rec002w_17Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_17',    
    ...
    dsDetailCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec002w_17_a').getView().select(0);
    	}
    },
    onExcel : function (){
    	var me = this;
    	...
    	console.log( Ext.encode(jsonAllData) );
      	...
      	var params = {
  			 FILE_PATH  : '/rec002w_17_excel.ozr' 

...
Ext.define('ExFrm.view.rec.rec002w_06_000031Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_06_000031',
    ...
    onSelectGDCallback : function(me, success, form, action){
    	...
    	if(success){
        	...
        	me.lookupReference('rec002w_06_000031_a').getView().select(0);
    ...
    onPrintGD : function(){
    	...
    	var params = {
  			 FILE_PATH  : '/rec002w_06_000031_rp_GDRec.ozr' 
  			,PRINT_DATA : jsonAllData
  		};
    	
    	if(rd_GDGbn == 1 || rd_GDGbn == 3){
    		params.FILE_PATH = '/rec002w_06_000031_rp_GDRec2.ozr';
    	}
    ...
    onMouseRightClick_A:function(record, data, index, rowIndex, eOpts){
    	...
    	var selectedRecord = me.lookupReference('rec002w_06_000031_a').getView().getSelectionModel().getSelection();

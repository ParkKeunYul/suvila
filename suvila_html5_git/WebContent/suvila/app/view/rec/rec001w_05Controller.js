Ext.define('ExFrm.view.rec.rec001w_05Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec001w_05',
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		...
    		for(var i = 0; i < row ; i++){
    			...
    			var bs_amount = me.getViewModel().getStore('ds_main').getAt(i).get("AMOUNT1");
    		...
    		me.lookupReference('em_sum_id').setExValue( bs_tot );

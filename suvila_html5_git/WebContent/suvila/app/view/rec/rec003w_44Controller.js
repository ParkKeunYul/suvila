Ext.define('ExFrm.view.rec.rec003w_44Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec003w_44',
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec003w_44_a').getView().select(0);
    	}
    },
    ...
    onExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec003w_44_a');
    	exCommon.excelDown(grid, 'chundoje', '천도제미수',  me.getViewModel().getStore('ds_RecGi').getCount());
    },
    onMisuExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec003w_04_d');
    	exCommon.excelDown(grid, 'chundoje', '수납현황',  me.getViewModel().getStore('ds_MisuAmtSagu').getCount());
    },

Ext.define('ExFrm.view.rec.rec001w_13Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec001w_13',
    ...
    onSelect : function(){
    	...
    	var params = {
     		...
     		,V_ACCEPT_SDATE 	: exCommon.getRepVal(me.lookupReference('me_AcceptSDateYD').getExValue(), '')
     		,V_ACCEPT_EDATE    	: exCommon.getRepVal(me.lookupReference('me_AcceptEDateYD').getExValue(), '')
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec001w_13_b').getView().select(0);    	
    	}
    },
    onExcel : function(){
    	var me = this;
	
    	var grid = me.lookupReference('rec001w_13_b');
    	exCommon.excelDown(grid, 'YD', '연등접수조회',  me.getViewModel().getStore('ds_YDRec').getCount());
    ...
    onBeforeeditGD : function(editor, context, eOpts ){
    	...
    	var PER_BUD_NO  = exCommon.getRepVal(me.lookupReference('rec001w_13_a').getStore().getAt(context.rowIdx).get("PER_BUD_NO"), "");
    	if( PER_BUD_NO != "" ){
    		return true;
    	}
    	return false;
    ...
    onDongchamUp : function(){
		...
		store_nm = "ds_DongChamJaYD";
    	grid_nm  = "rec001w_13_bb";
    ...
    onDongchamDown : function(){
    	...
    	var store_nm = "ds_DongChamJaYD";
    	var grid_nm  = "rec001w_13_bb";
   ...
   /* onSave : function(){
    ...
    onAdd : function(){
    	...
    	var store_nm_rec = "ds_YDRec";
    	var grid_nm_rec  = "rec001w_13_b"; 
    ...
    onMouseRightClickYD:function(record, data, index, rowIndex, eOpts){
    	...
    	var selectedRecord = me.lookupReference('rec001w_13_b').getView().getSelectionModel().getSelection();

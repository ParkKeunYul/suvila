Ext.define('ExFrm.view.rec.rec002w_35Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_35',
    ...
    onAfterRender:function(){
		...
		setTimeout(function(){
    		me.callStore(me, 'ds_BSKindInfo', '', null, me.dsBsdCallback);
    	},50);
    	
    },
    dsBsdCallback : function(me, success, form, action){
    	if(success){
    	}
    	setTimeout(function(){
    ...
    onSelect : function(){
    	...
    	var params = {
    		...
    		,V_TYPE         : exCommon.getRepVal(me.lookupReference('rdo_ApprovalGbn_r02_35').getValue().rdo_ApprovalGbn_r02_35, 3)
    	}
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		...
    		me.lookupReference('em_sum_bs').setExValue( bs_tot );
    	}
    },    
    setBudNo : function(){
    	var me = this;
    ...
    onStackedToggle: function (segmentedButton, button, pressed) {
        var chart = this.lookupReference('rec002w_35_a'),

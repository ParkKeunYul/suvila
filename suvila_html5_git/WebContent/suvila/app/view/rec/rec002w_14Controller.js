Ext.define('ExFrm.view.rec.rec002w_14Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_14',    
    ...
    onSelect : function (){
    	...
    	var param = {
    		...
    		,V_CODE   		   : me.lookupReference('lc_WPKindInfo').getExValue()
    ...
    dsDetailCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec002w_14_a').getView().select(0);
    	}
    },
    onExcel : function (){
    	var me = this;
    	...
    	jsonAllData = {
      	...
      	var params = {
  			 FILE_PATH  : '/rec002w_14_excel.ozr' 

Ext.define('ExFrm.view.rec.rec002w_16Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec002w_16',    
    ...
    onAfterRender:function(){
		...
		setTimeout(function(){
    		me.callStore(me, 'ds_aprayMgt', '', null ,me.dsAprayCallback);
    	},50);  
    	
    },
    dsAprayCallback : function(me, success, form, action){
    ...
    onDateField : function(){
    	...
    	var me_SDate = me.lookupReference('me_SDate').getExValue();
    	var me_EDate = me.lookupReference('me_EDate').getExValue();
    	
    	if(cb_date == 1){
    		me.lookupReference('me_SDate').format = "Y-m-d";
    		me.lookupReference('me_EDate').format = "Y-m-d";
    	}else{
    		me.lookupReference('me_SDate').format = "Y-m";
    		me.lookupReference('me_EDate').format = "Y-m";
    	}
    	
    	me.lookupReference('me_SDate').setExValue( me_SDate );
		me.lookupReference('me_EDate').setExValue( me_EDate );
    },
    onSelect : function (){
    	var me = this;
    	...
    	setTimeout(function(){
    		me.callStore(me, 'ds_GDRec', '', param , me.dsDetailCallback);
    	},50);
    },
    dsDetailCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec002w_16_a').getView().select(0);
    	}
    },
    onExcel : function (){
    	var me = this;
    	...
    	jsonAllData = {
      	...
      	var params = {
  			 FILE_PATH  : '/rec002w_16_excel.ozr' 

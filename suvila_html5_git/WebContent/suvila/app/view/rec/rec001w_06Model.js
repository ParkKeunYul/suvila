Ext.define('ExFrm.view.rec.rec001w_06Model', {
    extend:'Ext.app.ViewModel', 
    alias: 'viewmodel.rec001w_06', 
    stores:{ 
    	ds_IDRec_sel :{
         	fields:['field1'],
         	proxy:{
                 type:'ajax',
                 url:'/rec/REC001W_06/selectID.suvila',
                 reader:{
                     type:'json',
        ...
        ds_ID_CHRec_grd :{ //ds_ID_CHRec
         	fields:['field1'],
         	proxy:{
                 type:'ajax',
                 url:'/rec/REC001W_06/selectID_CH2.suvila',
                 reader:{
                     type:'json',
                     rootProperty:'data.list'                    
                 }

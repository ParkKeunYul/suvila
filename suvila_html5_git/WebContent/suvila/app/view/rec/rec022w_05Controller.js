Ext.define('ExFrm.view.rec.rec022w_05Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec022w_05',
    ...
    onInit:function(){
    	...
    	setTimeout(function(){
    		me.callStore(me, 'ds_JGKindInfo', '', null ,me.dsJkCallback);
    	},50);
    ...
    dsJkCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_KindInfo', '', null, null);
    	},50);
    },
    ...
    onSelect : function(){
    	...
    	var params = {
    		...
    		,V_DETAIL_GBN  : me.lookupReference('lc_KindInfo').getExValue()
    		,V_DETAIL_GBN2 : me.lookupReference('lc_JungakInfo').getExValue()
    	}
    ...
    onTooltipRender: function (tooltip, record, item) {
        tooltip.setHtml("원불/봉안 "+ exCommon.getGridDateFormat(record.get('SUB_DATE'), "/",8) + ': ' +record.get('AMOUNT1')+"원");

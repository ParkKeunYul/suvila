Ext.define('ExFrm.view.rec.rec002w_17',{
	extend:'ExFrm.view.widget.container.ExWindowMain',
	alias:'widget.rec002w_17',
	requires:[
		'ExFrm.view.rec.rec002w_17Controller',
        'ExFrm.view.rec.rec002w_17Model'
	],
	controller:'rec002w_17',
	viewModel:{
        type:'rec002w_17'
    },
    name:'rec002w_17',
	    ...
	    items:[{
	        ...
	        items:[{      
	            ...
	            items:[{
	                ...
	                cls       : 'rec002w_17_a  none-dirty-grid',
	                columns   : [{
	                	text        : '순번',
                        xtype       : 'rownumberer',
                        width       : 70,

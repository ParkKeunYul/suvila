Ext.define('ExFrm.view.rec.rec001w_16',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec001w_16',
    requires:[
    	'ExFrm.view.rec.rec001w_16Controller',
        'ExFrm.view.rec.rec001w_16Model',
    ],
    controller :'rec001w_16',
    viewModel:{
        type   :'rec001w_16'
    },
    name       : 'rec001w_16',
        			...
        			items        : [{
            			...
            			items        : [{
                			...
                			/*
                            	...
                            	inputValue : 3,    
                            	width      : 60,
                            	reference  : 'rp_acceptGbn4',
                            	*/
                			}]
            			},{
            				hidden       : true,
            				xtype        : 'radiogroup',
                			reference    : 'rp_acceptDeathGbn',
                			name         : 'rp_acceptDeathGbn',
                			listeners    : {
                				change : 'onRadioTypeClickDeath'
                			},
                    		items     :[{
                				boxLabel   : '단면', 
                            	inputValue : 1,    
                            	width      : 60,
                            	reference  : 'rp_acceptDeathGbn1',
                            	checked    : true
                    		},{
                    			boxLabel   : '양면', 
                            	inputValue : 3,    
                            	width      : 60,
                            	reference  : 'rp_acceptDeathGbn3'
                			}]
            			}]
        			},{

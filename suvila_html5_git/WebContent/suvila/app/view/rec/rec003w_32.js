Ext.define('ExFrm.view.rec.rec003w_32',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec003w_32',
    requires:['ExFrm.view.rec.rec003w_32Controller',
              'ExFrm.view.rec.rec003w_32Model',
              ],
    controller:'rec003w_32',
    viewModel:{
        type:'rec003w_32'
    },
    name:'rec003w_32',
        	   ...
        	   items :[{
        		    layout : 'hbox',
	           		...
	           		//	html   :'<div style="text-align:left;padding-left:2px;font-weight:700;padding-top:5px;">접수버튼 영역</div>',
	           			...
	           			xtype     :'radiogroup',
	           			reference : 'rdo_ApprovalGbn_r03_32',
	           			name      : 'rdo_ApprovalGbn_r03_32',
	           			/*listeners: {

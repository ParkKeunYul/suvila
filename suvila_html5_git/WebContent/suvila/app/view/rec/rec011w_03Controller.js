Ext.define('ExFrm.view.rec.rec011w_03Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec011w_03',
    ...
    onSelectCallback : function(me, success, form, action){
    	...
    	if(success){
    		me.lookupReference('rec011w_03_a').getView().select(0);    		
    	}
    },         
    onExcel : function(){
    	var me = this;
    	
    	var grid = me.lookupReference('rec011w_03_a');

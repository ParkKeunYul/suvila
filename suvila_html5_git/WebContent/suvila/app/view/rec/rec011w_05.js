Ext.define('ExFrm.view.rec.rec011w_05',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec011w_05',
    requires:[
    	'ExFrm.view.rec.rec011w_05Controller',
        'ExFrm.view.rec.rec011w_05Model',
        'Ext.chart.theme.Muted'
    ],
    controller :'rec011w_05',
    viewModel:{
        type   :'rec011w_05'
    },
    name       : 'rec011w_05',
        ...
        items :[{
        	...
        	items  : [{
        		...
        		items  :[{
        			...
        			xtype        :'excombobox',
                	labelWidth   : 60,
                    fieldLabel   : '<span style="font-weight: 700;">후원종류</span>',
                    width        : 300,
                    valueField   : 'SUPPORT_CODE',
                    displayField : 'SUPPORT_NM',     
                    reference    : 'lc_supportMgt',
                    emptyText    : '선택',
                	bind         : {
                    	store:'{ds_supportMgt}'
                	}

Ext.define('ExFrm.view.rec.rec011w_05Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec011w_05',
    ...
    onInit:function(){
    	...
    	setTimeout(function(){
    		me.callStore(me, 'ds_supportMgt', '', null ,me.dsaprayMgtCallback);
    	},50);
    ...
    dsaprayMgtCallback : function(me, success, form, action){
    	if(success){
    		me.getViewModel().getStore('ds_supportMgt').getAt(0).set("SUPPORT_NM", "선택");
    	}
    	setTimeout(function(){
    ...
    onSelect : function(){
    	...
    	var params = {
    		...
    		,V_SUPPORT_CODE	: me.lookupReference('lc_supportMgt').getExValue()
    ...
    onTooltipRender: function (tooltip, record, item) {
        tooltip.setHtml("후원접수 "+ exCommon.getGridDateFormat(record.get('SUB_DATE'), "/",8) + ': ' +record.get('AMOUNT1')+"원");

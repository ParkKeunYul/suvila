Ext.define('ExFrm.view.rec.rec001w_12',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec001w_12',
    requires:['ExFrm.view.rec.rec001w_12Controller',
              'ExFrm.view.rec.rec001w_12Model'
    ],
    controller:'rec001w_12',
    viewModel:{
        type:'rec001w_12'
    },
    name:'rec001w_12',
            ...
            items:[{
            	...
            	items :[{
            		...
            		//	width : 5
            			...
            			xtype     :'radiogroup',
            			reference : 'rdo_ApprovalGbn_r01_12',
            			name      : 'rdo_ApprovalGbn_r01_12',
            			/*listeners: {

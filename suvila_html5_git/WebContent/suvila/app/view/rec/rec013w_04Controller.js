Ext.define('ExFrm.view.rec.rec013w_04Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec013w_04',
    ...
    dsclassMgtCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_manageMgt', '', null ,me.dsSupportMgtCallback);
    	},50);
    	//ds_yn_gbn
    },     
    ...
    onSelect : function(){
    	...
    	me.getViewModel().getStore('ds_MisuAmt').removeAll();
    ...
    onSelectCallback : function(me, success, form, action){
    	...
    	if(success){
    		me.lookupReference('rec013w_04_a').getView().select(0);    		
    	}
    },   
    ...
    dsPayCallback : function(me, success, form, action){
    	if(success){
    		setTimeout(function(){
        		me.callStore(me, 'ds_MisuAmt', '', action._params ,me.dsMisuCallback);
        	},50);
    	}
    },
    ...
    onExcel : function(){
    	...
    	var grid = me.lookupReference('rec013w_03_a');
    	exCommon.excelDown(grid, 'manage', '관리비 접수내역',  me.getViewModel().getStore('ds_detail').getCount());    	
    },
    onDateField : function(){
    ...
    onSave : function(){
    	...
    	exCommon.fnGridSaveAll(
	   			...
	   			,'uptData'
	   			,'delData'
	   			,'/rec/REC013W_03/saveDetail.suvila'
	   			,me.onSaveCallback
	   	);

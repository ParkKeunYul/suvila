Ext.define('ExFrm.view.rec.rec003w_24Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec003w_24',
    ...
    onSelect : function(){
    	...
    	setTimeout(function(){    		
    		me.callStore(me, 'ds_RecSagu', '', params ,me.onSelectCallback);
    	},50);    	
    },
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec003w_24_a').getView().select(0);
    	}
    },
    ...
    onExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec003w_24_a');
    	exCommon.excelDown(grid, 'jesa49', '49재미수',  me.getViewModel().getStore('ds_RecSagu').getCount());
    },
    onMisuExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec003w_04_d');
    	exCommon.excelDown(grid, 'jesa49', '수납현황',  me.getViewModel().getStore('ds_MisuAmtSagu').getCount());
    },

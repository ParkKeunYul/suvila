Ext.define('ExFrm.view.rec.rec014w_04Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec014w_04',
    ...
    onSelectCallback : function(me, success, form, action){
    	...
    	if(success){
    		me.lookupReference('rec014w_04_a').getView().select(0);    		
    	}
    },
    onSelectionChange : function( me2 , record , selections , eOpts ) {
    	...
    	try{
    		...
    		var selection = me.lookupReference('rec014w_04_a').getView().getSelectionModel().getSelection()[0];
    		...
    		setTimeout(function(){
        		me.callStore(me, 'ds_MisuAmt', '', params ,me.dsMisuAmtCallback);
        	},50);
    ...
    dsMisuAmtCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec014w_04_b').getView().select(0);
    	}
    },
    onExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec014w_04_a');
    	exCommon.excelDown(grid, '영탐접수', '영탑접수 미수내역',  me.getViewModel().getStore('ds_detail').getCount());    	
    },
    onExcelMisu : function(){
    	var me = this;
    	var grid = me.lookupReference('rec014w_04_b');
    	var record = me.lookupReference('rec014w_04_b').getView().getSelectionModel().getSelection()[0];
    	exCommon.excelDown(grid, '영탑접수', '영탑접수 납부내역('+record.get("BUD_NM")+")",  me.getViewModel().getStore('ds_MisuAmt').getCount());
    },

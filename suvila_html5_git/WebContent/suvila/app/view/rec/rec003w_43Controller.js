Ext.define('ExFrm.view.rec.rec003w_43Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec003w_43',
    ...
    onSelectCallback : function(me, success, form, action){
    	...
    	if(success){
    		me.lookupReference('rec003w_43_a').getView().select(0);
    ...
    onSaveKind : function(){
    	...
    	exCommon.fnGridSaveAll(
    			...
    			,'uptData'
    			,'delData'
    			,'/rec/REC003W_43/saveSaguJaeKind.suvila'
    ...
    onSaveYoungga : function(){
    	...
    	exCommon.fnGridSaveAll(
    			...
    			,'uptData'
    			,'delData'
    			,'/rec/REC003W_43/saveYoungga.suvila'
    ...
    onSave : function(){
    	...
    	exCommon.fnGridSaveAll(
    		...
    		,'uptData'
    		,'delData'
    		,'/rec/REC003W_43/uptChundoJesaDate.suvila'
    		,me.onSaveCallback
    	);
    },
    ...
    onExcel : function(){
    	var me = this;
    	var grid = me.lookupReference('rec003w_43_a');
    	exCommon.excelDown(grid, 'chundoje', '천도제',  me.getViewModel().getStore('ds_giJae').getCount());
    },
    ...
    onPrintBok : function(){
    	...
    	me.openPopup('ExFrm.view.rec.rec000p_02_7',  selectedRecord.data, null);
    },

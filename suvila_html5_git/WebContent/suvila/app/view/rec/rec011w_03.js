Ext.define('ExFrm.view.rec.rec011w_03',{
    extend: 'ExFrm.view.widget.container.ExPanelBox',
    alias:'widget.rec011w_03',
    requires:[
    	'ExFrm.view.rec.rec011w_03Controller',
        'ExFrm.view.rec.rec011w_03Model'
    ],
    controller:'rec011w_03',
    viewModel:{
        type:'rec011w_03'
    },
    name:'rec011w_03',
        	...
        	items  : [{
        		...
        		items  :[{
	                ...
	                columns:[{
	                	...
	                	text        : '후원자 휴대번호',
	                	xtype       : 'excolumn',
	                    dataIndex   : 'SUPPORT_MOBILE_TELNO',                    
	                    exAlign     : 'left',
	                    width       : 120,
	                    sortable    : true,
	                    renderer    : function(value, meta, record, rowIndex, colIndex, store, view){

Ext.define('ExFrm.view.rec.rec001w_15Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec001w_15',
    ...
    dstempleUserCallback : function(me, success, form, action){
		...
		setTimeout(function(){
    		me.callStore(me, 'ds_JGKindInfo', '', params ,me.dsJGKindInfoCallback);
    	},50);
    },
    ...
    dsJGKindInfoCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_DKindInfo', '', action._params ,null);
    	},50);
    },
    ...
    onSelect : function(){
    	...
    	var params = {
    		...
    		,V_DETAIL_GBN 	: me.lookupReference('lc_DJungakInfo').getExValue()
    		,V_DETAIL_GBN2 	: me.lookupReference('lc_DKindInfo').getExValue()
    		,V_USER     	: me.lookupReference('lc_templeUser').getExValue()
    		,V_TYPE         : exCommon.getRepVal(me.lookupReference('rdo_ApprovalGbn').getValue().rdo_ApprovalGbn, 1)
    	}
    ...
    onSelectCallback : function(me, success, form, action){
    	if(success){
    		...
    		for(var i = 0; i < row ; i++){
    			var gd_amount = me.getViewModel().getStore('ds_main').getAt(i).get("AMOUNT2");
    			
    			if(gd_amount > 0 ||  gd_amount == 0 ){
    				gd_cnt ++;
    				gd_tot = parseInt(gd_tot) + gd_amount;
    			}
    		} 
    		
    		me.lookupReference('em_sum_yd').setExValue( gd_tot );
    	}
    },   

Ext.define('ExFrm.view.rec.rec026w_01Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.rec026w_01',    
    ...
    onSelect : function (){
    	...
    	var param = {
    		...
    		,V_APPROVAL_GBN   : me.lookupReference('lc_approv').getExValue()
    ...
    dsDetailCallback : function(me, success, form, action){
    	if(success){
    		me.lookupReference('rec026w_01_a').getView().select(0);
    	}
    },
    onExcel : function (){
    	var me = this;
    	var grid = me.lookupReference('rec026w_01_a');
    	
    	exCommon.excelDown(grid, 'SUNAP', '가족수납현황',  me.getViewModel().getStore('ds_main').getCount());
    }

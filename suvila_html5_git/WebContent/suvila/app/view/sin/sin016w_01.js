Ext.define('ExFrm.view.sin.sin016w_01',{
	extend:'ExFrm.view.widget.container.ExWindowMain',
	alias:'widget.sin016w_01',
	requires:[
		'ExFrm.view.sin.sin016w_01Controller',
        'ExFrm.view.sin.sin016w_01Model'
	],
	controller:'sin016w_01',
	viewModel:{
        type:'sin016w_01'
    },
    name:'sin016w_01',
	            ...
	            items:[{
	                ...
	                columns   : [{
	                    ...
	                    renderer  : function(value, meta, record, rowIndex, colIndex, store, view){
	                    	...
	                    	var url = PHOTO_IP+"/suvila/upload"+PHOTO_FOLDER+"/"+PHOTO;
	                    	
	                    	if(R_PHOTO != ''){
	                    		return '<img src="http://'+url+'" height="40">';
	                    	}else{
	                    		return '';
	                    	}

Ext.define('ExFrm.view.widget.column.ExColumnGroupWidgetCheckboxGroup', {
    extend: 'Ext.grid.column.Widget',
    xtype:'excolumngroupwidgetcheckboxgroup',    
    ...
    onWidgetAttach:function(col, widget, rec){
        ...
        //console.log('1widget rec', rec);
        //widget.setValue(rec.get(this.exValueField));
        //if(widget.store.getData().getSource() != null ){  
    ...
    initComponent:function(){
        ...
        this.widget = {
            ...
            exValueField:this.exValueField,
            height:20,
            style: {

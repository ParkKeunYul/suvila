Ext.define('ExFrm.view.acc.acc010w_01Controller', {
    extend: 'ExFrm.view.base.ViewController',
    alias: 'controller.acc010w_01',    
    ...
    dsIeGbnCallback : function(me, success, form, action){
    	setTimeout(function(){
    		me.callStore(me, 'ds_approval', '', null, me.dsApproValCallback);
    	},50);
    },
    dsApproValCallback : function(me, success, form, action){
    	var params = {
       		 V_ACCT_GBN : '1'
       		,V_IE_GBN   : 'I'
       		,V_HANG     : "0"
    ...
    onKwanChange : function(){
    	...
    	if(me.loadState.length == 0){
    		var params = {
   	       		...
   	       		,V_IE_GBN   : me.lookupReference('lc_iegbn').getExValue()
   	       		,V_KWAN     : me.lookupReference('lc_kwan').getExValue()
   	       		,KWAN       : me.lookupReference('lc_kwan').getExValue()
   	       	};
    		setTimeout(function(){
    ...
    onSave : function(){
    	...
    	for(var i =0; i < rowCnt ; i++){
    		jsonNewData.push(me.lookupReference('acc010w_01_a').getStore().getAt(i).data);
    	}// for
    	...
    	Ext.MessageBox.confirm('알림', '저장 하시겠습니까?', function(btn){
    		if (btn == 'yes') {
    			...
    			setTimeout(function(){
    				me.callForm(me, '/acc/acc010w_01/save.suvila', me.onSaveCallback , false);
    			},10);	
    		}
    	});
    ...
    onEdit : function( ){
    	...
    	for(var i =0; i < rowCnt ; i++){
    		...
    		var AMOUNT = me.lookupReference('acc010w_01_a').getStore().getAt(i).get("AMOUNT1");
    ...
    onExcel : function(){
    	...
    	var baseData = {
    		 TITLE    : '재무회계 '+me.lookupReference('em_yyyy').getRawValue()+'년도 결산'        		
    	}
    	...
    	jsonAllData = {
       	...
       	var params = {
   			 FILE_PATH  : '/acc010w_01_excel.ozr' 
   			,PRINT_DATA : jsonAllData
       	};
